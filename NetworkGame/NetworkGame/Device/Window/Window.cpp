#include "Window.h"
#include <atlstr.h>
#include "Device/Window/WindowProcedures.h"
#include "Utility/Debug.h"

namespace {
Math::Vector2 convertWindowSize(HWND hWnd, const Math::Vector2& clientSize) {
...
bool createWindow(HWND* hWnd,
    const Math::Vector2& clientSize, const Math::Vector2& position,
    ...
    wcex.lpfnWndProc = toWindowEndApplicationQuit ? Window::WindowProcedures::mainWndProc : Window::WindowProcedures::subWndProc;
    ...
    //ウィンドウの大きさを取得
    const Math::Vector2 windowSize = convertWindowSize(*hWnd, clientSize);
    //ウィンドウの生成    
