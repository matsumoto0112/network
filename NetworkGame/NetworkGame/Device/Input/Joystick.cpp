#include "Joystick.h"
#include "Device/Input/ControllerUtil.h"
#include <d3d11.h>
namespace {
...
*/
bool checkButtonDown(const JOYINFOEX& info, Input::ButtonID button) {
    //UINTに変換し入力を調べる
    ...
    if (btn > (1 << 15)) {
        ...
        switch (button) {
        case Input::ButtonID::Up:
            return pov < 9000 || pov > 27000;
        case Input::ButtonID::Right:
            return 0 < pov && pov < 18000;
        case Input::ButtonID::Down:
            return 9000 < pov && pov < 27000;
        case Input::ButtonID::Left:
